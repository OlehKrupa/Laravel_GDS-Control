                    ...
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-200">
                        ...
                        @foreach ($journals as $index => $journal)
                            ...
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-100' : 'bg-white' }}">
                                <td class="px-3 py-2 whitespace-nowrap border border-gray-200">{{ \Carbon\Carbon::parse($journal->created_at)->format('d.m.y H:i') }}</td>
                                <td class="px-3 py-2 whitespace-nowrap border border-gray-200">{{ $journal->station->label ?? 'N/A' }}</td>
                                <td class="px-3 py-2 whitespace-nowrap border border-gray-200">{{ $journal->user->name }} {{ $journal->user->surname }}</td>

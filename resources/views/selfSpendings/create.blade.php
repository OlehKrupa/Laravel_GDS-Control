                    ...
                    <form method="POST" action="{{ route('selfSpendings.store') }}">
                        ...
                        <div class="flex items-center mb-4">
                            <label for="heater_time"
                                   class="w-64 text-lg font-semibold text-gray-800 bg-gray-200 py-2 px-4 rounded-l-md">{{ __('Heater Time') }}
                                :</label>
                            <div class="flex w-64">
                        ...
                        <div class="flex items-center mb-4">
                            <label for="boiler_time"
                                   class="w-64 text-lg font-semibold text-gray-800 bg-gray-200 py-2 px-4 rounded-l-md">{{ __('Boiler Time') }}
                                :</label>
                            <div class="flex w-64">
                                <input type="text" name="boiler_time" id="boiler_time"
                                       class="w-64 py-2 px-4 border border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                       value="{{ old('boiler_time') }}"/>
                                <span
                                    class="inline-flex items-center px-3 text-gray-700 bg-gray-200 border border-l-0 border-gray-300 rounded-r-md">Год.</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-4">
                            <label for="heater_gas"
                                   class="w-64 text-lg font-semibold text-gray-800 bg-gray-200 py-2 px-4 rounded-l-md">{{ __('Heater Gas') }}
                                :</label>
                            <div class="flex w-64">
                                <input type="text" name="heater_gas" id="heater_gas"
                                       class="w-64 py-2 px-4 border border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                       value="{{ old('heater_gas') }}"/>
                                <span
                        ...
                        <div class="flex items-center mb-4">
                            <label for="boiler_gas"
                                   class="w-64 text-lg font-semibold text-gray-800 bg-gray-200 py-2 px-4 rounded-l-md">{{ __('Boiler Gas') }}
                                :</label>
                            <div class="flex w-64">
                                <input type="text" name="boiler_gas" id="boiler_gas"
                                       class="w-64 py-2 px-4 border border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                       value="{{ old('boiler_gas') }}"/>
                                <span
                                    class="inline-flex items-center px-3 text-gray-700 bg-gray-200 border border-l-0 border-gray-300 rounded-r-md">M3</span>
                            </div>
                        </div>

                        ...
                        <tr>
                            ...
                            @foreach ($columns as $column => $label)
                                <th scope="col"
                                    ...
                                    <a href="{{ route('notes.index', ['sort' => $column, 'direction' => $currentSort == $column && $currentDirection == 'asc' ? 'desc' : 'asc', 'days' => request('days', 1), 'user_station_id' => request('user_station_id')]) }}">
                                        {{ $label }}
                            ...
                            <tr class="{{ $index % 2 === 0 ? 'bg-gray-100' : 'bg-white' }}">
                                ...
                                <td class="px-2 py-2 whitespace-nowrap border border-gray-200 text-center">
                                    <div class="inline-flex">
                                        @if ($note->created_at->gt(now()->subDays(3)))
